...
@section('body')
    ...
    <section class="mt-4">
        <div class="w-full flex">
            <a href="/form" class="flex justify-center items-center w-full font-bold border-dashed border-2 border-primary text-primary rounded-lg py-5 px-10 me-4 text-sm duration-150">
                + Pengajuan Ethical Clearance
            </a>
            <a href="" class="card w-fit flex flex-col items-center">
